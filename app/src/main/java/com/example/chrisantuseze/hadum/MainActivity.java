...
public class MainActivity extends AppCompatActivity
    ...
    private StorageReference mImageStorage, mImageStorage2;
    private static final int GALLERY_PICK = 1;
    String uId;
    String name, email, regno, dept, level, profileKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageStorage2 = FirebaseStorage.getInstance().getReference();
...
//        mCurrentUser = FirebaseAuth.getInstance().getCurrentUser();
        ...
        if (mUserInfo.getKeyDepartment() != null) {
            ...
            profileKey = mUserInfo.getKeyEmail();
        }

        mImageStorage2.child("profile_image/thumb").child(profileKey + ".jpg")
...
//                        .child("thumb").child(currentUserID + ".jpg");
                StorageReference filepath = mImageStorage.child("profile_image").child(profileKey
                        + ".jpg");
                final StorageReference thumb_filepath = mImageStorage.child("profile_image")
                        .child("thumb").child(profileKey + ".jpg");
...
//                                        update_map.put("thumb_image", thumb_downloaadUrl);
//
//                                        StyleableToast.makeText(getApplicationContext(), download_url, R.style.success).show();
//
////                                        mDatabase.updateChildren(update_map)
////                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
////                                                    @RequiresApi(api = Build.VERSION_CODES.M)
...
////                            });
//                        } else {
//                            StyleableToast.makeText(getApplicationContext(), "Uploading failed", R.style.error).show();
//                            // dialog.dismiss();
//                        }
//                    }
//                });
