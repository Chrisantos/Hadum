...
public class ThursDB extends SQLiteOpenHelper {
    public static final String TABLE_NAME = "thurs";
    public static final String DATABASE = "thursday.db";
    private static final int VERSION = 1;


    public ThursDB(Context context) {
