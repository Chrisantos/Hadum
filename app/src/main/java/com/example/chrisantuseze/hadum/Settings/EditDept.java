...
public class EditDept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Edit Department");
...
//        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child(uId).child("regno");
        ...
        mEditDept = (EditText)findViewById(R.id.edit_dept);
        mBtnSave = (Button)findViewById(R.id.btn_edit_dept);
...
//    private void changeDept(final String dept){
//        mUserDatabase.setValue(dept).addOnCompleteListener(new OnCompleteListener<Void>() {
//            @Override
