...
import static com.example.chrisantuseze.hadum.Timetable.DBs.ThursDB.TABLE_NAME;
import static com.example.chrisantuseze.hadum.Timetable.Days.Contract.DayEntry.*;

public class AddThurs extends AppCompatActivity {
    private EditText etCourse, etVenue;
    private TextView tvStart, tvEnd;

    private SQLiteDatabase db;
    private ThursDB dbHelper;
    Toolbar mToolbar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_thurs);
        ...
        tvStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(AddThurs.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        actionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(enteredCourse)){
                    Toast.makeText(AddThurs.this, "You must enter a course first", Toast.LENGTH_LONG).show();
                    return;
                }
                if(TextUtils.isEmpty(enteredVenue)){
                    Toast.makeText(AddThurs.this, "You must enter a venue first", Toast.LENGTH_LONG).show();
                    return;
                }
