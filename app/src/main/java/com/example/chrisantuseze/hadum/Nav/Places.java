...
public class Places extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlaceDetectionClient = com.google.android.gms.location.places.Places.getPlaceDetectionClient(this, null);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                Typeface custom_font_bio = Typeface.createFromAsset(getAssets(),  "fonts/Aller_Rg.ttf");

                TextView title = ((TextView) infoWindow.findViewById(R.id.title));

                title.setTypeface(custom_font_bio);
                title.setText(marker.getTitle());

                TextView snippet = ((TextView) infoWindow.findViewById(R.id.snippet));
                snippet.setTypeface(custom_font_bio);
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Log.e("ChrisTask", ""+task);
                            mLastKnownLocation = task.getResult();
                            Log.e("Chris", ""+task.getResult());
