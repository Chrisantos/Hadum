...
import static com.example.chrisantuseze.hadum.Timetable.DBs.FriDB.TABLE_NAME;
import static com.example.chrisantuseze.hadum.Timetable.Days.Contract.DayEntry.*;

public class AddFri extends AppCompatActivity {
    private EditText etCourse, etVenue;
    private TextView tvStart, tvEnd;

    private SQLiteDatabase db;
    private FriDB dbHelper;
    Toolbar mToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(AddFri.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        actionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(enteredCourse)){
                    Toast.makeText(AddFri.this, "You must enter a course first", Toast.LENGTH_LONG).show();
                    return;
                }
                if(TextUtils.isEmpty(enteredVenue)){
                    Toast.makeText(AddFri.this, "You must enter a venue first", Toast.LENGTH_LONG).show();
                    return;
                }
