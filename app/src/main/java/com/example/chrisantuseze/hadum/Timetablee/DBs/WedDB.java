...
public class WedDB extends SQLiteOpenHelper {
    public static final String TABLE_NAME = "wed";
    public static final String DATABASE = "wednessday.db";
    private static final int VERSION = 1;


    public WedDB(Context context) {
